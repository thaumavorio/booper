  ...
  render() {
    return (
      <div className="text-page">
        ...
        <p>During our study of bootstrap percolation, we noticed a lack of visualization tools. On top of our theoretical results, we decided to provide such a tool to assist in further study of the topic. Bootstrap percolation is a very active research field, and we believe that Booper can help make this research more efficient.</p>
      </div>
    );
  }
}
